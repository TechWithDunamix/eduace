    ...
    <footer className="bg-primary/5 border-t border-border/40">
      <div className="container px-4 md:px-6 py-12">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" className="flex items-center space-x-2 mb-4">
              <Image src="/images/eduace-logo.png" alt="Eduace Logo" width={36} height={36} className="h-8 w-auto" />
              <span className="font-bold text-xl text-primary">Eduace</span>
            </Link>
            <p className="text-muted-foreground mb-4">
              Revolutionizing online education with an intuitive, comprehensive learning management system.
            </p>
        ...
        <div className="border-t border-border/40 mt-12 pt-8 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Eduace. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
